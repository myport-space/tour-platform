    ...
    return (
      <AdminLayout>
        <div className="text-center py-12">
          <h2 className="text-xl font-semibold text-gray-900">Tour not found</h2>
          <p className="text-gray-600 mt-2">The tour you're looking for doesn't exist.</p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">Category: {tour.category.name}</span>
                  </div>
                </div>

                <div>
                  <p className="text-sm text-gray-600">
                    <strong>Tour Operator:</strong> {tour.tourOperator.user.name}
                  </p>
                  <p className="text-sm text-gray-600">
                    <strong>Contact:</strong> {tour.tourOperator.user.email}
                  </p>
                </div>
              </div>
              ...
              <Card key={spot.id} className="border-2 border-gray-200">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <h4 className="font-medium text-sm">Bookings ({spot.bookings.length})</h4>
